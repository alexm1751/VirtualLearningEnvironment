...
$app->map(['GET', 'POST'], '/registerpass', function(Request $request, Response $response) use ($app) {

    echo ('Registered, Please wait for an admin to finalise your account!');
//    $c_arr_clean_message = [];
//
